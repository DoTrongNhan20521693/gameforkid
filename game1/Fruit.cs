...
namespace game1
{
    public partial class Fruit : Form
    {
        ...
        private void Fruit_Load(object sender, EventArgs e)
        {
            ...
            nodeList = xmlDoc.SelectNodes("/fruits" + "/fruit");
        ...
        public void StartLevel()
        {
            ...
            picWord.BackgroundImage = Image.FromFile(@"..\\..\\pictures in use\Fruits\" + pic);
            lbl_Answer.Text = ans;
        ...
        private void Fruit_Load_1(object sender, EventArgs e)
        {
            xmlDoc.Load(@"..\\..\\Fruits.xml");
            nodeList = xmlDoc.SelectNodes("/fruits" + "/fruit");
